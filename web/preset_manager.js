...
export function makeWindow({ title, width = "500px", height = "500px", minWidth = "380px", minHeight = "300px", zIndex = "10001" }) {
    ...
    Object.assign(win.style, {
        ...
        background: "#181825", border: "1px solid #45475a", borderRadius: "10px",
    ...
    Object.assign(titleBar.style, {
        height: "36px", flexShrink: "0", cursor: "move", background: "#1e1e2e",
    ...
    Object.assign(titleLabel.style, { color: "#cdd6f4", fontSize: "13px", fontWeight: "bold", marginLeft: "4px", flex: "1" });
    ...
    Object.assign(resizeHandle.style, { position: "absolute", right: "0", bottom: "0", width: "0", height: "0", borderStyle: "solid", borderWidth: "0 0 18px 18px", borderColor: "transparent transparent #45475a transparent", cursor: "nwse-resize", zIndex: "10" });
...
export class PresetManager {
    ...
    _render() {
        ...
        topBar.appendChild(this._mkBtn("📦 Export All",       "#1f2d3b", () => this._exportJSON(presets, `cwk_presets_${this._panelKey}_all.json`)));
        topBar.appendChild(this._mkBtn("📂 Import from JSON", "#2a1f3b", () => this._importJSON()));
        ...
        if (names.length === 0) {
            ...
            Object.assign(empty.style, { color: "#45475a", fontSize: "13px", textAlign: "center", padding: "20px 0" });
        ...
        names.forEach(name => {
            ...
            Object.assign(wrapper.style, { background: "#1e1e2e", borderRadius: "6px", border: "1px solid #313244", overflow: "hidden" });
            ...
            Object.assign(preview.style, { display: "none", padding: "8px 12px", borderTop: "1px solid #313244", fontSize: "11px", color: "#a6adc8", lineHeight: "1.6", wordBreak: "break-word", whiteSpace: "pre-wrap", background: "#11111b", maxHeight: "120px", overflowY: "auto" });
            ...
            const loadBtn   = this._mkBtn("Load",      "#1f3b2a", () => { this._canvas.setValue(presets[name]); this.hide(); });
            const renameBtn = this._mkBtn("✏️ Rename", "#2a2a3b", () => {
            ...
            const exportBtn = this._mkBtn("💾 Export", "#1f2d3b", () => this._exportJSON({ [name]: presets[name] }, `cwk_preset_${name}.json`));
            const delBtn    = this._mkBtn("🗑 Delete", "#3b1f1f", () => {
    ...
    _mkBtn(text, bg, onClick) {
        ...
        Object.assign(btn.style, { padding: "4px 10px", background: bg, color: "#cdd6f4", border: "none", borderRadius: "5px", cursor: "pointer", fontSize: "12px", whiteSpace: "nowrap", flexShrink: "0" });
